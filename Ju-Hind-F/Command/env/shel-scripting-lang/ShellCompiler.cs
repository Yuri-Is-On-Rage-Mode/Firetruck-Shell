...
using firetruck.Command.env.shel_scripting_lang.ByteCode;
using firetruck.Utils;

namespace firetruck.Command.env.shel_scripting_lang
{
    ...
    public class Tokenizer
    {
        ...
        class TokErrors
        {
            ...
            public static void PleaseSeperateThem(string tok, string msg)
            {
                ...
                firetruckErrorList.New($"Tok: `{tok}`: {msg}");
                firetruckErrorList.ListThemAll();
